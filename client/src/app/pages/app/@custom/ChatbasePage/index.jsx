...
import { Sidebar, SidebarSection, SidebarItem } from '@/app/components/@system/Sidebar'
...
import { useChatbaseSettings } from '@/app/hooks/@custom/useChatbaseSettings'
...
export function ChatbasePage() {
  ...
  const { fetchSettings, saveSettings, testConnection, removeSettings } = useChatbaseSettings()
  ...
  async function handleTest() {
    ...
    setTestResult(null)
    try {
      const result = await testConnection(chatbotId)
