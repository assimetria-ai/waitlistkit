...
function WaitlistCard({ waitlist, onInvite }) {
  return (
...
export function WaitlistKitDashboardPage() {
  ...
  async function handleInviteWaitlist(waitlistId) {
  ...
  async function handleInviteSubscriber(subscriberId) {
    try {
