...
import { useBlogAdmin } from '../../../hooks/@custom/useBlogAdmin'
...
interface PostFormProps {
  ...
  onClose: () => void
  onSaved: () => void
  onSave: (id: number | null, body: object) => Promise<void>
}

function PostFormModal({ post, onClose, onSaved, onSave }: PostFormProps) {
  const isEdit = !!post
  ...
  async function handleSubmit(e) {
    ...
    try {
      await onSave(isEdit ? post!.id : null, body)
      onSaved()
    } catch (err) {
...
function DeleteDialog({ post, onClose, onDeleted, onDelete }: DeleteDialogProps) {
...
export function BlogAdminPage() {
  ...
  const { posts, loading, fetchPosts, saveBlogPost, togglePublish: hookTogglePublish, deleteBlogPost } = useBlogAdmin()
