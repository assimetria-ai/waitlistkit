...
// @custom — posts load via useBlogPosts hook (DB-backed via admin panel). BLOG_POSTS is a fallback.
...
import { useBlogPosts } from '../../../hooks/@system/useBlog.js'
...
export function BlogPage() {
  ...
  // Load posts via hook (pages → hooks → api layer)
